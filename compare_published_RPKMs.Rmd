...
f.tmm <- mapply("*",as.data.frame(f.nolow),nf)
pheatmap(cor(f.tmm,method="spearman"))
f.log.tmm <- log2(f.tmm+pseudo) log2.cpm(f.tmm)
...
Combat analysis is performed on logged values after removal of all rows (n=204) with FPKM=zero in all samples
